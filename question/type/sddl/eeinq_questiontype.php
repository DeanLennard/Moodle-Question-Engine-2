 ...
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_eeinq extends question_type {
    ...
    public function save_question_options($question) {
        ...
        foreach ($question->choices as $key => $choice) {
            ...
            $feedback = $this->feedback_serialization($choice);
    ...
    protected function initialise_question_instance(question_definition $question, $questiondata) {
        ...
        foreach ($questiondata->options->answers as $choicedata) {
            $choice = $this->feedback_unserialization($choicedata);
    ...
    protected function get_array_of_choices($question) {
        ...
        foreach ($subquestions as $key=>$subquestion) {
            ...
            $answers[$count] += $this->feedback_unserialize_as_array($subquestion->feedback);
